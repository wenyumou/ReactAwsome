...
export default class HomeScreen extends React.Component {
    ...
    loadData() {
        ...
        fetch(
            "https://www.jgospel.net//Portals/_default/Skins/JGospel2016/Json/typeJson.js"
        )
            ...
            .then(json => {
                ...
                fetch(
                    "https://www.jgospel.net//Portals/_default/Skins/JGospel2016/Json/typeContent.js"
                )
                    .then(response => response.json())
                    .then(json => {
                        jg.typeContent = json;
                        console.log(
                            "got typeContent length=" + jg.typeContent.length
                        );
                        this.setState(
                            {
                                isLoading: false,
